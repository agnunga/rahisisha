...
<html lang="en">
    <head>
        ...
        <!--<link id="switcher" href="assets/css/theme-color/yellow-theme.css" rel="stylesheet">-->
        <!-- Main Style -->
    ...
    <body>
        ...
        <header id="header">
            <div class="header-inner">
                ...
                <div class="header-overlay">
                    <div class="header-content" style="padding-top: 8%;">
                        <!-- Start header content slider -->
                        <h2 class="header-slide">RAHISISHA PROVIDES
                            <span>CREATIVE</span>
                            <span>RELIABLE</span>
                        ...
                        <hr/>
                        <!-- Start menu section -->
                        <div style="position: absolute; bottom: 0px; left: 0px; background: #fff; width: 100%">
                            <section id="menu-area" style="margin-bottom: 25px;">
                                <nav class="navbar navbar-default main-navbar" role="navigation">  
                                    <div class="container">
                                        <div class="navbar-header">
                                            ...
                                            <!-- LOGO -->     
                                            <!-- Image logo  -->
                                            <a class="navbar-brand logo" href="/"><img src="assets/images/logo.png" style="height: 100%; width: auto;" alt="logo"></a> 
                                        </div>
                                ...
                                <ul class="wc-table">
                                    <li>
                                        <div class="single-wc-content wow fadeInUp">
                                            ...
                                            <p>
                                                We get you a uniquely tailored solution with very high level of creativity; vividly distinct from the commonly offered.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="single-wc-content wow fadeInUp">
                                            ...
                                            <p>
                                                We design a user interface that is attractive and simple to use. The UI that communicated your standards to your clients.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-6 col-xs-12">
                                    <div class="about-left wow fadeInLeft">
                                        <img src="assets/images/about-img.jpg" style="" alt="img">
                                    ...
                                    <div class="about-right wow fadeInRight">
                                        <div class="title-area">
                                            ...
                                            <p>
                                                ...
                                                quality of our services. For what and who we are we believe in customer satisfaction.
                                            </p> 

                                            <p>
                                                Any approach we take is determined to showing our commitment in improving all sectors to embrace technology in their production and 
                                                marketing.
                                            </p>
                                            <div class="about-btn-area">
                                                <a href="#contact" class="button button-default" data-text="LEAVE US A MESSAGE"><span>LEAVE US A MESSAGE</span></a>
                                            </div>                    
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="team-area">
                            <div class="title-area">
                                ...
                                <span class="tittle-line"></span>
                                <p>
                                    RAHISISHA has a team that easens your work and makes your problem and proporsed solutions easier to understand. They are the following:
                                </p>
                            </div>
                            <!-- Start team content -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="service-area">
                            <div class="title-area">
                                <h2 class="tittle">Our Core Service</h2>
                                <span class="tittle-line"></span>
                                <p>
                                    This is a software development firm. The main services that we offer are listed below, but not limited to those alone.
                                </p>
                            </div>
                            <!-- service content -->
                                ...
                                <ul class="service-table">
                                    ...
                                    <li class="col-md-3 col-sm-6">
                                        <div class="single-service wow slideInUp">
                                            ...
                                            <p>
                                                With technology in business, accountability is paramount.
                                            </p>
                                        </div>
                                    </li>
                                    <li class="col-md-3 col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="portfolio-area">
                            <div class="title-area">
                                ...
                                <span class="tittle-line"></span>
                                <p>
                                    These are some of the project we have worked on recently.
                                </p>
                            </div>
                            <!-- Portfolio content -->
                                ...
                                <div class="portfolio-container">
                                    <div class="single-portfolio">
                                        <div class="single-item">
                                            <img src="assets/images/skylink_logo.png" alt="img">
                                            <div class="single-item-content">
                                                <div class="portfolio-social-icon">
                                                    <a class="view-btn" href="#"><i class="fa fa-search-plus"></i></a>
                                                </div>
                                                <div class="portfolio-title">
                                                    <h4>Skylink Agency Application</h4>
                                                </div>
                                                <div class="portfolio-detail">
                                                    <a href="#" class="modal-close-btn"><span class="fa fa-times"></span></a>
                                                    <img src="assets/images/skylink_logo.png" alt="img-1" />
                                                    <h2>>Skylink Agency Application</h2>
                                                    <p>
                                                        Skylink Agency Application is a web based application
                                                    </p>
                                                    <a href="" class="view-project-btn">Visit the site</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-portfolio">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-content">
                                                ...
                                                <div class="portfolio-detail">
                                                    <a href="#" class="modal-close-btn"><span class="fa fa-times"></span></a>
                                                    <img src="assets/images/portfolio-img-big1.jpg" alt="img-2" />
                                ...
                                <ul class="price-table">
                                    <li class="wow slideInUp">
                                        <div class="single-price">
                                            ...
                                            <p>Maintenance fee</p>
                                            <a data-text="order" class="button button-default" href="#"><span>ORDER</span></a>
                                        </div>
                                    </li>
                                    <li class="wow slideInUp">
                                        <div class="single-price standard-price">
                                            <h4 class="price-header">Business Website</h4>
                                            <span class="price-amount">From KSH 30,000</span>
                                            <p>Custom design</p>
                                            <p>Upgradding fee</p>
                                            <a data-text="order" class="button button-default" href="#"><span>ORDER</span></a>
                                        </div>
                                    ...
                                    <li class="wow slideInUp">
                                        <div class="single-price">
                                            <h4 class="price-header">Android App</h4>
                                            <span class="price-amount">From KSH 30,000</span>
                                            <p>Custom specification</p>
                                            <p>Upgrading fee</p>   
                                            <a data-text="order" class="button button-default" href="#"><span>ORDER</span></a>
                                        </div>
                                    </li>
                                    <li class="wow slideInUp">
                                        <div class="single-price">
                                            <h4 class="price-header">IT Support</h4>
                                            <span class="price-amount">From 5,000/mo</span>
                                            <p>Preventive Maintenance</p>
                                            <p>OS and software Installation</p>
                                            <a data-text="order" class="button button-default" href="#"><span>ORDER</span></a>
                                        </div>
                                    </li>
                                </ul>     
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div  style="text-align: center; margin: 5px auto 0 31%;">
                            <a data-text="Book Now" class="button button-default" href="#">
                                <span>Become Our Client</span>
                            </a>
                            <a data-text="Write Review" class="button button-default" href="#">
                                <span>Review  Us Now</span>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <footer id="footer">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="footer-top-area">             
                                <a class="footer-logo" href="#"><img src="assets/images/logo.png" style="height: 100px; width: auto;" alt="Logo"></a>              
            ...
            <div class="footer-bottom">
                <p>Designed by: <a rel="nofollow" href="http://www.agunga.rahisisha.co.ke/">agunga3d&#8482;</a></p>
            </div>
        </footer>
        <!-- End Footer -->
